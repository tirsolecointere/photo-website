<nav x-data="{ open: false }" class="bg-white border-b border-stone-100">
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <div class="shrink-0 flex items-center">
                    <a href="{{ route('admin.home') }}">
                        <x-application-logo class="block h-10 w-auto fill-current text-stone-600" />
                    </a>
                </div>
            ...
            <div class="hidden sm:flex sm:items-center sm:ml-6">
                <a href="{{ route('home') }}" class="inline-block bg-stone-50 hover:bg-stone-100 rounded-md text-stone-500 hover:text-stone-800 p-2 text-sm font-medium mr-5" target="_blank">
                    Go to Website
                ...
                <x-dropdown align="right" width="48">
                    <x-slot name="trigger">
                        <button class="flex items-center text-sm font-medium text-stone-500 hover:text-stone-700 hover:border-stone-300 focus:outline-none focus:text-stone-700 focus:border-stone-300 transition duration-150 ease-in-out">
    ...
    <div :class="{'block': open, 'hidden': ! open}" class="hidden sm:hidden">
        <div class="pt-2 pb-3 space-y-1">
            ...
            <x-responsive-nav-link :href="route('admin.files.index')" :active="request()->routeIs('admin.files.*')">
                Gallery
            </x-responsive-nav-link>
        </div>
