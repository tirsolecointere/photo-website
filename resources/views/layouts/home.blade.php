...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <body class="bg-white font-mono antialiased pb-8">
        {{-- edges --}}
        ...
        <nav class="flex items-center justify-center bg-white/90 backdrop-blur-md backdrop-saturate-200 py-2 lg:py-4 mx-4 lg:mx-8 mt-8 h-16 lg:h-24 fixed top-0 right-0 left-0 w-100 z-40">
            <div class="flex-grow mx-auto px-4 lg:px-8 flex md:justify-between items-center gap-4">
                <div>
                    <button class="flex w-10 h-10 justify-center items-center bg-zinc-900 hover:bg-zinc-700 rounded-full text-white">
                ...
                <div class="hidden md:block">
                    <a href="javascript:void(0)" class="block bg-zinc-900 hover:bg-zinc-700 text-white text-sm py-3 px-4 md:px-6 rounded-full">get in touch</a>
                </div>
            </div>
        </nav>
